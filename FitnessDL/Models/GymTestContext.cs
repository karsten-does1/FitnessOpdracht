...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=MSI\\SQLEXPRESS;Initial Catalog=GymTest;Integrated Security=True;Encrypt=False;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ReservationDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Equipment).WithMany(p => p.ReservationDetails)
                .HasForeignKey(d => d.EquipmentId)
                .HasConstraintName("FK_reservation_details_equipment");

            entity.HasOne(d => d.Reservation).WithMany(p => p.ReservationDetails)
                .HasForeignKey(d => d.ReservationId)
                .HasConstraintName("FK_reservation_details_reservation");

            entity.HasOne(d => d.TimeSlot).WithMany(p => p.ReservationDetails)
                .HasForeignKey(d => d.TimeSlotId)
                .HasConstraintName("FK_reservation_details_time_slot");
        });
